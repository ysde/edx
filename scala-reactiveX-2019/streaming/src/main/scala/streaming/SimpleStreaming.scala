...
object SimpleStreaming extends ExtraStreamOps {
  ...
  /**
    ...
    */
  def filterUsingPreviousFlowAndMapToStringsUsingTwoVias(ints: Source[Int, NotUsed],
  ...
  /**
    ...
    */
  def sumUntilBackpressureGoesAway: Flow[Int, Int, _] = Flow[Int].conflate((i1, i2) => i1 + i2)
  ...
  def keepRepeatingLastObservedValue: Flow[Int, Int, _] =
    Flow[Int].extrapolate((e: Int) => Iterator.continually(e))
